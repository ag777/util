...
public class MysqlConnection extends BaseDbConnectionUtils {
	...
	private static String DRIVER_DEFAULT = DbDriverNames.MYSQL;
	...
	public static void setToOldDriver() {
		driver(DbDriverNames.MYSQL_OLD);
	}
	...
	/**
	 * @see #connect(String driverName, String, int, String, String, String, Map)
	 * @param ip ip
	 * @param port port
	 * @param user user
	 * @param password password
	 ...
	 * @throws SQLException SQLException
	 */
	public static Connection connect(String driverName, String ip, int port, String user, String password, String dbName, Map<String, Object> propMap) throws ClassNotFoundException, SQLException {
		/*这种写法同时支持ipV4和V6*/
		...
		return connect(driverName, url.toString(), user, password, propMap);
	}
	 ...
	 * @throws SQLException SQLException
	 */
	public static Connection connect(String driverName, String url, String user, String password, Map<String, Object> propMap) throws ClassNotFoundException, SQLException {
		Properties props = getProperties(propMap);
		return DbConnectionUtil.connect(url, user, password, driverName, props);
	}
