package github.ag777.util.lang.calculate;

import github.ag777.util.lang.StringUtils;
import github.ag777.util.lang.exception.model.DivisorIsZeroException;
...
public class CalculateHelper {
	 ...
	 * </p>
	 * @param augend augend
	 * @return 返回计算后的CalculateHelper实例，支持链式调用
	 */
	...
	public CalculateHelper divide(Object divisor) {
		...
		num = num.divide(valueOfWithException(divisor), 10, java.math.RoundingMode.HALF_DOWN);
		return this;
	}
	 ...
	 * @param divisor divisor
	 * @return 返回计算后的CalculateHelper实例，支持链式调用
	 * @throws DivisorIsZeroException 当除数为0时抛出此异常
	 */
	 ...
	 * 将任意类型转换为BigCecimal
	 * @param obj obj
	 * @return 包含转换后BigDecimal的Optional对象，如果转换失败则返回空Optional
	 */
